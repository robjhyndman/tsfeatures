...
`comengine` calculate the features that have been used in the [CompEngine](https://www.comp-engine.org/) database, using a method introduced in package `kctsa`.
