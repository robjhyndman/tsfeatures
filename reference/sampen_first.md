...
Modified from the Ben Fulcher's `EN_SampEn` which uses code from
PhysioNet. The publicly-available PhysioNet Matlab code, sampenc
(renamed here to RN_sampenc) is available from:
